...
void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOE,
                      PULSE_2_Pin | PULSE_3_Pin | MOT_L_IN2_Pin | MOT_L_IN1_Pin | MOT_L_IN4_Pin | MOT_L_IN3_Pin |
                          MOT_R_IN2_Pin | MOT_R_IN1_Pin | MOT_R_IN3_Pin | MOT_R_IN4_Pin,
                      GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : PULSE_2_Pin PULSE_3_Pin MOT_L_IN2_Pin MOT_L_IN1_Pin
                             ...
                             MOT_R_IN3_Pin */
    GPIO_InitStruct.Pin = PULSE_2_Pin | PULSE_3_Pin | MOT_L_IN2_Pin | MOT_L_IN1_Pin | MOT_L_IN4_Pin | MOT_L_IN3_Pin |
                          MOT_R_IN2_Pin | MOT_R_IN1_Pin | MOT_R_IN3_Pin;
