...
static void inv_reGenerate_sensorControl(struct inv_icm20948 * s, const int32_t *sen_num_2_ctrl, unsigned short *sensor_control, uint8_t header2_count);
...
*/
static void inv_convert_androidSensor_to_control(struct inv_icm20948 * s, unsigned char androidSensor, unsigned char enable, const int32_t *sen_num_2_ctrl, unsigned short *sensor_control)
{
	short delta = 0;
...
static int inv_enable_sensor_internal(struct inv_icm20948 * s, unsigned char androidSensor, unsigned char enable, char * mems_put_to_sleep)
{
	...
	const int32_t inv_androidSensor_to_control_bits[ANDROID_SENSOR_NUM_MAX]=
	{
